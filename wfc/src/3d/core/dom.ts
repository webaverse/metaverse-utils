import { IDisposable, Disposable, toDisposable } from './disposeble';
/*---------------------------------------------------------------------------------------------
...
function _wrapAsStandardMouseEvent(handler: (e: MouseEvent) => void): (e: MouseEvent) => void {
...
// export function triggerDownload(dataOrUri: Uint8Array | any, name: string): void {
